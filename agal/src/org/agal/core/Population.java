...
/**
 * Population represents a genetic algorithm population which may be implemented in one of
 * many ways and which may even be altered on the fly by the environment. Implementations
 * must be thread safe.
 * <p>
 * TODO - Notes on thread safety (see EvolutionControlThread).
 * @author David Schmidt
 */
public interface Population<S>
{
	...
	/**
	 * Indicates to the Population that it's time to move to the next generation.
